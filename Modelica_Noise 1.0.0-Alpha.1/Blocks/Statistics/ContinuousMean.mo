...
<pre>    integral( u over time)</pre><pre>y = ----------------------</pre><pre>      time - start time</pre>
<p>This can be used to determine the empirical expactation value of a random signal, such as generated by the <a href=\"Blocks.Noise\">Noise</a> blocks.</p>
