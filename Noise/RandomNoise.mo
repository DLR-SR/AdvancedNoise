...
// The internal functions are used later in redeclarations
public
  replaceable function distribution = Noise.PDF.PDF_Uniform
...
protected
  function SampleBasedPDF0 = distribution(redeclare function RNG =
          SampleBasedRNG0);
  function SampleFreePDF0 =  distribution(redeclare function RNG =
          SampleFreeRNG0);
...
public
  replaceable function interpolation = Noise.PSD.PSD_WhiteNoise constrainedby
...
protected
  function SampleBasedPSD0 =
    interpolation (                    redeclare function PDF=SampleBasedPDF0);
...
public
  parameter Boolean enableNoise = globalSeed.enableNoise
    ...
    annotation(choices(choice=true "true",choice=false "false",choice=globalSeed.enableNoise
        "inherit from globalSeed"),  Dialog(
                                   tab="Advanced",group = "Enable/Disable"));
