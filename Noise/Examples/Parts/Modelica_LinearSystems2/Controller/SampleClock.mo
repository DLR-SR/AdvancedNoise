...
block SampleClock
  ...
  parameter Types.BlockType blockType=Types.BlockType.Continuous
    ...
    annotation (
      Evaluate=true,
      choices(__Dymola_radioButtons=true, choice=Noise.Examples.Parts.Modelica_LinearSystems2.Controller.Types.BlockType.Continuous
        "Continuous",
        choice=Noise.Examples.Parts.Modelica_LinearSystems2.Controller.Types.BlockType.Discrete
        "Discrete"));
  ...
  parameter Types.Init initType=Noise.Examples.Parts.Modelica_LinearSystems2.Controller.Types.Init.SteadyState
