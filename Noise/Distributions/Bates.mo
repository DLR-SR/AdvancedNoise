...
function Bates
  "Bates distribution (mean of uniform variables in a given interval)"
...
algorithm
  ...
  // Retrieve IrwinHall distribution
  (rand, stateOut) := IrwinHall(generator=  generator, stateIn=  stateIn, interval=interval, n=n);
