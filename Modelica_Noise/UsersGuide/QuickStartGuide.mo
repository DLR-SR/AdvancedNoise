...
<p>To model a noise source in using this library, the u the block <a href=\"Modelica_Noise.RandomNoise\">Modelica_Noise.RandomNoise</a> has to be selected. properly parametrizing this block is done on two levels: easy and advanced:</p>
...
<p><br>For more information, please also see <a href=\"Modelica_Noise.RandomNoise.SampleBasedRNG\">Modelica_Noise.RandomNoise.SampleBasedRNG</a>: </p>
</html>",
        revisions="<html>
