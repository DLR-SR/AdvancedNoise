...
block NormalDensity "Calculates the density of a normal distribution"
  import distribution = Modelica_Noise.Math.Distributions.Normal.density;
...
<a href=\"Modelica_Noise.Math.Distributions.Normal.density\">Math.Distributions.Normal.density</a>).
</p>
