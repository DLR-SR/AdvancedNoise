...
package Math "Mathematical functions use in this library"
  ...
  annotation (
    Icon(graphics={      Line(points={{-80,0},{-68.7,34.2},{-61.5,53.1},
...
<p>
This package contains some <strong>additonal mathematical functions</strong>
provided for noise signal generation.
</p>
