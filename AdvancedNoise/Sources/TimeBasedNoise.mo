...
<tr><td> generator </td>
    <td> Defines the pseudo random number generator to be used. This is
         ...
         in the package description of the Generators package.</td></tr>
...
<tr><td> useGlobalSeed </td>
    <td> = true, if the seed (= Integer number) defined in the &quot;inner
         ...
         a&nbsp;Monte Carlo simulation, then useGlobalSeed has to be set to false.</td></tr>

<tr><td> useAutomaticLocalSeed </td>
    <td> An Integer number, called local seed, is needed to initalize the random
...
<tr><td> fixedLocalSeed </td>
    <td> If useAutomaticLocalSeed&nbsp;= false, the local seed to be used.
         ...
         numbers produce statistically meaningful numbers.</td></tr>
...
<tr><td> startTime </td>
    <td> The time instant at which noise shall be generated at the output&nbsp;y.
         ...
         a&nbsp;time instant after this duration.</td></tr>
</table>
</html>", revisions="<html>
<table border=\"1\" cellspacing=\"0\" cellpadding=\"2\">
  <tr>
